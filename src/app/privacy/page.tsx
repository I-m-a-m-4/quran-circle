  ...
  return (
    <div className="min-h-screen bg-black text-gray-400 p-8 pt-24 max-w-3xl mx-auto space-y-8 font-serif leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <p>Muslim Desk collects minimal data to facilitate habit tracking. We use your email and display name provided by the Quran Foundation via OAuth2.</p>
      </section>
      <section className="space-y-4">
        <p className="text-white font-bold">2. Quran Foundation Integration</p>
        <p>Our application integrates with the Quran Foundation Content and User APIs. Your spiritual progress (streaks) is stored securely and only visible to members of your Muslim Desk.</p>
      </section>
      <section className="space-y-4">
